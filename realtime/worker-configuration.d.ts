/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=realtime/wrangler.jsonc realtime/worker-configuration.d.ts` (hash: 3799988b808c8804c3e1b325e774b33f)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	ORDER_HUB: DurableObjectNamespace<import("./src/index").OrderHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OrderHub";
	}
