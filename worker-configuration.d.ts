/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0ddeac81375e3fd55f7f9e4b17df7790)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESTAURANT_ID" | "AUTH_PEPPER">> {}
}
